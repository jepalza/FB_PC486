...
'
static shared As Integer vga_bpp
...
static shared As Integer video_res_x, video_res_y, video_vga_bpp
...
/'Vertical timings'/
static shared As Integer svga_vtotal, svga_dispend, svga_vsyncstart, svga_split, svga_vblankstart
/'Horizontal timings'/
